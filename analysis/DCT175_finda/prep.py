...
def raw_data_concat(media_filter = [], from_date='', to_date=''):
    paid_df = get_paid_df(info.paid_dir)
    organic_df = get_organic_df(info.organic_dir)
...
def get_campaign_cost_df(raw_dir, from_date = '', to_date = ''):
    cost_file = raw_dir + '/핀다_220601_220930 예산.xlsx'
