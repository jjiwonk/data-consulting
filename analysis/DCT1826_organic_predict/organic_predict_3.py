...
def get_model_data():
    ...
    season_month_fall = [9, 10, 11]
    season_month_winter = [12, 1, 2]
    ...
    # 휴일 정보 생성
    date_list = pd.date_range('2022-03-01', '2023-09-30')
...
def get_predicted_install(params, tmp_data, year, month, peak_month):
    # Prophet 객체 생성
    m = Prophet(**params)
...
eval_4, install_4 = get_predicted_install(params, model_data, 2023, 4, peak_month)
eval_5, install_5 = get_predicted_install(params, model_data, 2023, 5, peak_month)
eval_6, install_6 = get_predicted_install(params, model_data, 2023, 6, peak_month)
eval_7, install_7 = get_predicted_install(params, model_data, 2023, 7, peak_month)
eval_8, install_8 = get_predicted_install(params, model_data, 2023, 8, peak_month)
eval_9, install_9 = get_predicted_install(params, model_data, 2023, 9, peak_month)
eval_10, install_10 = get_predicted_install(params, model_data, 2023, 10, peak_month)
eval_11, install_11 = get_predicted_install(params, model_data, 2023, 11, peak_month)
eval_12, install_12 = get_predicted_install(params, model_data, 2023, 12, peak_month)
