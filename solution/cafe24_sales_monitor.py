        ...
        try:
            ...
            if not monitor_detail:
                ...
                while cur_sales_amt == "-":
                    if retry_cnt == 2:
                        break
                    cur_sales_amt = driver.find_element(By.CSS_SELECTOR, '#react-dom-root > div.MuiContainer-root.MuiContainer-maxWidthXl.css-ou99bh > div.MuiGrid-root.MuiGrid-container.MuiGrid-spacing-xs-24.css-1h77wgb > div:nth-child(2) > div > div.MuiCardContent-root.css-1b9luhs > div > div > div > table > tbody > tr.MuiTableRow-root.css-1jdwrdl > td:nth-child(2) > div > div.MuiStack-root.css-1uxxqyn > a').text
                    retry_cnt += 1
                    time.sleep(2)
